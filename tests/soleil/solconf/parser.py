...
class TestParser(TestCase):
    ...
    def test_args_kwargs_calls(self):
        ...
        for call, expected in [
            ...
            self.assertEqual(parser.safe_eval(call), expected)
    ...
    def test_register(self):
        ...
        self.assertEqual(parser.safe_eval("with_last(first)"), "John Doe")

        self.assertEqual(parser.safe_eval("with_last('Jane')"), "Jane Doe")
        ...
        try:
            ...
            self.assertEqual(
                str(err.__cause__), "'Name `first` undefined in parser context.'"
            )
        else:
