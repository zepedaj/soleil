...
# from links import extlinks, prolog_links  # noqa
...
latex_documents = [
    (master_doc, "soleil.tex", "SOLEIL Documentation", "Joaquin Zepeda", "manual"),
]
...
man_pages = [(master_doc, "soleil", "soleil Documentation", [author], 1)]
